...
# python -u glue_trans.py --dir pre_distilbert --output_dir tmp/distilbert2 --logging_steps 12271 --task_name MRPC --data_dir glue_data/MRPC --model_type distilbert --model_name_or_path distilbert-base-uncased --do_train --do_eval --do_lower_case --max_seq_length 128 --per_gpu_train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 5 --overwrite_output_dir --evaluate_during_training --save_steps 0 --eval_all_checkpoints --seed 3 --checkpoint_dir checkpoints/distilbert2/ --pruning_steps 10 > logs/distilbert_mrpc2.log

# python -u glue_trans.py --dir pre_distilbert --output_dir tmp/distilbert3 --logging_steps 12271 --task_name MRPC --data_dir glue_data/MRPC --model_type distilbert --model_name_or_path distilbert-base-uncased --do_train --do_eval --do_lower_case --max_seq_length 128 --per_gpu_train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 5 --overwrite_output_dir --evaluate_during_training --save_steps 0 --eval_all_checkpoints --seed 3 --checkpoint_dir checkpoints/distilbert3/ --pruning_steps 10 > logs/distilbert_mrpc3.log

# python -u glue_trans.py --dir pre_distilbert_new --output_dir tmp/distilbert3 --logging_steps 12271 --task_name MRPC --data_dir glue_data/MRPC --model_type distilbert --model_name_or_path distilbert-base-uncased --do_train --do_eval --do_lower_case --max_seq_length 128 --per_gpu_train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 5 --overwrite_output_dir --evaluate_during_training --save_steps 0 --eval_all_checkpoints --seed 3 --checkpoint_dir checkpoints/distilbert3/ --pruning_steps 10 > logs/distilbert_mrpc3.log
...
# python -u glue_trans.py --dir pre_distilbert --output_dir tmp/distilbert_oneshot --logging_steps 12271 --task_name MRPC --data_dir glue_data/MRPC --model_type distilbert --model_name_or_path distilbert-base-uncased --do_train --do_eval --do_lower_case --max_seq_length 128 --per_gpu_train_batch_size 32 --learning_rate 2e-5 --num_train_epochs 0 --overwrite_output_dir --evaluate_during_training --save_steps 0 --eval_all_checkpoints --seed 42 --checkpoint_dir checkpoints/distilbert_oneshot/ --pruning_steps 10 --per_gpu_train_batch_size 16 --per_gpu_eval_batch_size 16 --oneshot True > logs/distilbert_mrpc_oneshot.log
# run PTQ jobs on pruned_finetuned_model1.pth pruned_finetuned_model2.pth
